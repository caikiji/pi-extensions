...
| `jump` | Navigable context anchors: `label`/`jump` to fold away intermediate work, `label_list`/`label_peek` to enumerate anchors and read folded content, plus context-metrics (window/physical/in-view tokens) |
